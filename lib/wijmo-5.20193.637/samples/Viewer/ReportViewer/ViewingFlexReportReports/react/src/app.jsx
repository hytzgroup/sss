...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            ...
            <wjViewer.ReportViewer filePath={'ReportsRoot/' + this.state.filePath} reportName={this.state.reportName} paginated={true} serviceUrl="https://demos.componentone.com/ASPNET/c1webapi/4.0.20172.105/api/report">
