                ...
                <div className="row">
                    ...
                    <div className="col-xs-6">
                        <div className="gauge-holder">
                            <RadialGauge isReadOnly={false} min={0} max={100} step={this.state.step} value={this.state.value} showRanges={false} startAngle={this.state.startAngle} sweepAngle={this.state.sweepAngle} autoScale={this.state.autoScale} valueChanged={s => { this.setState({ value: s.value }); }}>
