...
export class AppComponent {
    ...
    @ViewChild('cboFontName') cboFontName: input.ComboBox;
    @ViewChild('cboFontSize') cboFontSize: input.ComboBox;
    @ViewChild('cboTableStyles') cboTableStyles: input.ComboBox;
    @ViewChild('colorPicker') colorPicker: input.ColorPicker;
