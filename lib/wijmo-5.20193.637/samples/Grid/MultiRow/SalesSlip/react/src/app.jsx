...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            <wjMultiRow.MultiRow id="orderDetail" itemsSource={this.state.items} layoutDefinition={this.state.layoutDefinition} initialized={this.initSlip}></wjMultiRow.MultiRow>
