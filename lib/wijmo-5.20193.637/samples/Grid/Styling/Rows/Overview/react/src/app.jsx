...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            ...
            <wjcGrid.FlexGrid itemsSource={this.state.data} alternatingRowStep={0} initialized={this.initialGrid.bind(this)}>
    ...
    onShowAlternatingRowsClick(e) {
        this.grid.showAlternatingRows = e.target.checked;
    }
}
