...
class App extends React.Component {
    ...
    chartInitialized(chart) {
        this.theChart = chart;
        wjCore.addClass(chart.hostElement, 'custom-titles custom-legend');
    }
    headerChanged(combo) {
        this.setState({
            header: combo.text
    ...
    customTitlesChanged() {
        ...
        if (this.theChart) {
            wjCore.toggleClass(this.theChart.hostElement, 'custom-titles');
        }
    }
    //
    customLegendChanged() {
        ...
        if (this.theChart) {
            wjCore.toggleClass(this.theChart.hostElement, 'custom-legend');
        }
    }
    //
