...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            ...
            <Finance.FinancialChart itemsSource={this.state.data} bindingX="date" symbolSize={6} tooltipContent="tooltip" chartType="Candlestick" palette={this.state.palette} initialized={this.initializeChart.bind(this)}>
