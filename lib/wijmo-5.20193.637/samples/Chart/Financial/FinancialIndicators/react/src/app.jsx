...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            ...
            <wjFinance.FinancialChart itemsSource={this.state.data} bindingX="date" palette={this.state.palette} initialized={this.initializeChart}>
            ...
            <wjFinance.FinancialChart itemsSource={this.state.data} style={{ height: '200px' }} bindingX="date" palette={this.state.palette} rendered={this.chartRendered} initialized={this.initializeIChart}>
