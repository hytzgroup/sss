...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            <wjChart.FlexChart itemsSource={this.state.data} bindingX="date" chartType="HighLowOpenClose" palette={this.state.palette} tooltipContent="" initialized={this.initializeChart.bind(this)}>
