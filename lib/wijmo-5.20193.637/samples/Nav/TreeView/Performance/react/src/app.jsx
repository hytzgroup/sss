        ...
        return (<div className="container-fluid">
                <div className="row">
                    <div className="col-xs-5">
                        ...
                        <ComboBox itemsSource={this.state.levels} selectedValue={this.state.selectedLevel} selectedIndexChanged={s => {
            this.setState({ selectedLevel: s.selectedValue });
        }}/>
                        <br />
                        <label htmlFor="cmbLevels">Nodes/Level:</label>
                        <ComboBox itemsSource={this.state.nodesPerLevel} selectedValue={this.state.selectedNodesPerLevel} selectedIndexChanged={s => {
