...
class App extends React.Component {
    ...
    render() {
        return (<div className="container-fluid">
                ...
                <wjNav.TreeView itemsSource={this.state.data} displayMemberPath="header" childItemsPath="items" isContentHtml={true} initialized={this.initTreeView.bind(this)} className={this.state.customCSS ? "accordion" : ""}></wjNav.TreeView>
            </div>);
    }
    initTreeView(ctl) {
    ...
    onCustomCSSClick() {
        wjCore.toggleClass(this._wjTreeViewControl.hostElement, 'accordion', !this.state.customCSS);
        this.setState({
