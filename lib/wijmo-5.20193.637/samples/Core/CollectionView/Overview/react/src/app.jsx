...
class App extends React.Component {
    constructor(props) {
        ...
        this._cv.currentChanged.addHandler(() => this.forceUpdate());
        this.state = {
            isEditing: false,
    ...
    componentDidMount() {
        new CollectionViewNavigator("#navigator", this._cv);
        new CollectionViewPager("#pager", this._cv);
        //this.setState({ groupedList: this._cv.items });
    }
